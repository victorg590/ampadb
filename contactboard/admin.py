...
from .models import Alumne, Classe, Curs
...
class AlumneAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'nom', 'cognoms', 'classe', 'correu_alumne', 'telefon_alumne',
        'correu_tutor_1', 'telefon_tutor_1', 'correu_tutor_2',
        'telefon_tutor_2'
    ]
    list_editable = [
        'correu_alumne', 'telefon_alumne', 'correu_tutor_1', 'telefon_tutor_1',
